...
INSERT INTO `service_settings` VALUES ('svc-sftp','sftp',0,9022,'0.0.0.0',NULL,NULL,'2026-09-18 14:15:42',NULL,0),('svc-webdav','webdav',0,NULL,'0.0.0.0',NULL,NULL,NULL,NULL,0),('svc-ftp','ftp',0,9021,'0.0.0.0',NULL,NULL,NULL,NULL,0),('svc-oss','oss',0,NULL,'0.0.0.0',NULL,NULL,NULL,NULL,0);
/*!40000 ALTER TABLE `service_settings` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oss_access_keys`
--

DROP TABLE IF EXISTS `oss_access_keys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `oss_access_keys` (
  `id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '密钥ID',
  `user_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '所属用户ID',
  `access_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Access Key（对外可见）',
  `secret_key` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Secret Key（AES-GCM 密文 Base64，SigV4 验签需还原明文）',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `status` int NOT NULL DEFAULT '0' COMMENT '状态 0正常 1吊销',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='OSS 对外服务访问密钥';
...
CREATE TABLE `storage_platform` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='存储平台';
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `storage_platform` WRITE;
/*!40000 ALTER TABLE `storage_platform` DISABLE KEYS */;
INSERT INTO `storage_platform` VALUES (28,'阿里云OSS','AliyunOSS','[{\"label\": \"Access-Key\", \"dataType\": \"string\", \"identifier\": \"accessKey\", \"validation\": {\"required\": true}}, {\"label\": \"Secret-key\", \"dataType\": \"string\", \"identifier\": \"secretKey\", \"validation\": {\"required\": true}}, {\"label\": \"服务器端点\", \"dataType\": \"string\", \"identifier\": \"endpoint\", \"validation\": {\"required\": true}}, {\"label\": \"存储桶名\", \"dataType\": \"string\", \"identifier\": \"bucket\", \"validation\": {\"required\": true}}, {\"label\": \"区域\", \"dataType\": \"string\", \"identifier\": \"region\", \"validation\": {\"required\": true}}]','icon-aliyun1','https://www.aliyun.com/product/oss',0,'阿里云对象存储 OSS（Object Storage Service）是一款海量、安全、低成本、高可靠的云存储服务'),(30,'RustFS对象','RustFS','[{\"label\": \"Access-Key\", \"dataType\": \"string\", \"identifier\": \"accessKey\", \"validation\": {\"required\": true}}, {\"label\": \"Secret-key\", \"dataType\": \"string\", \"identifier\": \"secretKey\", \"validation\": {\"required\": true}}, {\"label\": \"服务器端点\", \"dataType\": \"string\", \"identifier\": \"endpoint\", \"validation\": {\"required\": true}}, {\"label\": \"存储桶名\", \"dataType\": \"string\", \"identifier\": \"bucket\", \"validation\": {\"required\": true}}]','icon-bendicunchu1','https://github.com/rustfs/rustfs',0,'RustFS 是一个基于 Rust 构建的高性能分布式对象存储系统。Rust 是全球最受开发者喜爱的编程语言之一，RustFS 完美结合了 MinIO 的简洁性与 Rust 的内存安全及高性能优势。它提供完整的 S3 兼容性，完全开源，并专为数据湖、人工智能（AI）和大数据负载进行了优化。'),(31,'FTP','FTP','[{\"label\": \"服务器地址\", \"dataType\": \"string\", \"identifier\": \"ftpHost\", \"validation\": {\"required\": true}}, {\"label\": \"端口\", \"dataType\": \"string\", \"identifier\": \"ftpPort\", \"validation\": {\"required\": false}}, {\"label\": \"用户名\", \"dataType\": \"string\", \"identifier\": \"ftpUsername\", \"validation\": {\"required\": true}}, {\"label\": \"密码\", \"dataType\": \"string\", \"identifier\": \"ftpPassword\", \"validation\": {\"required\": true}}, {\"label\": \"启用FTPS\", \"dataType\": \"string\", \"identifier\": \"ftpsEnabled\", \"validation\": {\"required\": false}}, {\"label\": \"被动模式\", \"dataType\": \"string\", \"identifier\": \"passiveMode\", \"validation\": {\"required\": false}}, {\"label\": \"控制连接编码\", \"dataType\": \"string\", \"identifier\": \"controlEncoding\", \"validation\": {\"required\": false}}, {\"label\": \"分片临时目录\", \"dataType\": \"string\", \"identifier\": \"tempPath\", \"validation\": {\"required\": false}}]','icon-bendicunchu1',NULL,0,'通过 FTP/FTPS 协议接入传统文件服务器，支持被动模式与 TLS 加密（FTPS），兼容各类老牌主机面板。'),(32,'WebDAV','WebDAV','[{\"label\": \"服务端点\", \"dataType\": \"string\", \"identifier\": \"webdavEndpoint\", \"validation\": {\"required\": true}}, {\"label\": \"用户名\", \"dataType\": \"string\", \"identifier\": \"webdavUsername\", \"validation\": {\"required\": true}}, {\"label\": \"密码\", \"dataType\": \"string\", \"identifier\": \"webdavPassword\", \"validation\": {\"required\": true}}, {\"label\": \"基础路径\", \"dataType\": \"string\", \"identifier\": \"webdavBasePath\", \"validation\": {\"required\": false}}, {\"label\": \"分片临时目录\", \"dataType\": \"string\", \"identifier\": \"tempPath\", \"validation\": {\"required\": false}}]','icon-bendicunchu1',NULL,0,'通过 WebDAV 协议接入坚果云、Alist、Nextcloud 等网盘与自建服务，跨平台通用性强。'),(33,'本地存储','Local','[{\"label\": \"存储根目录\", \"dataType\": \"string\", \"identifier\": \"basePath\", \"validation\": {\"required\": true}}, {\"label\": \"开启落盘加密\", \"dataType\": \"boolean\", \"identifier\": \"encryptionEnabled\", \"validation\": {\"required\": false}, \"description\": \"开启后新写入的文件以 AES-CTR 加密落盘；变更密钥将导致旧文件无法解密，请谨慎保管\"}, {\"label\": \"加密密钥\", \"showIf\": {\"value\": \"true\", \"identifier\": \"encryptionEnabled\"}, \"dataType\": \"string\", \"identifier\": \"encryptionSecret\", \"validation\": {\"required\": false}, \"placeholder\": \"开启加密后必填；密钥变更后旧文件将无法解密\"}]','icon-bendicunchu1',NULL,1,'系统内置的本地磁盘存储；也支持添加多个不同根目录的本地存储实例。'),(34,'SMB网络','Smb','[{\"label\": \"服务器地址\", \"dataType\": \"string\", \"identifier\": \"smbHost\", \"validation\": {\"required\": true}}, {\"label\": \"端口\", \"dataType\": \"string\", \"identifier\": \"smbPort\", \"validation\": {\"required\": false}}, {\"label\": \"域\", \"dataType\": \"string\", \"identifier\": \"smbDomain\", \"validation\": {\"required\": false}}, {\"label\": \"共享名\", \"dataType\": \"string\", \"identifier\": \"smbShare\", \"validation\": {\"required\": true}}, {\"label\": \"用户名\", \"dataType\": \"string\", \"identifier\": \"smbUsername\", \"validation\": {\"required\": true}}, {\"label\": \"密码\", \"dataType\": \"string\", \"identifier\": \"smbPassword\", \"validation\": {\"required\": true}}, {\"label\": \"分片临时目录\", \"dataType\": \"string\", \"identifier\": \"tempPath\", \"validation\": {\"required\": false}}]','icon-bendicunchu1',NULL,0,'通过 SMB/CIFS 协议接入局域网共享目录（Windows 共享、Samba 等），适合家庭 NAS 与内网文件服务器场景。'),(35,'SFTP','SFTP','[{\"label\": \"服务器地址\", \"dataType\": \"string\", \"identifier\": \"sftpHost\", \"validation\": {\"required\": true}}, {\"label\": \"端口\", \"dataType\": \"string\", \"identifier\": \"sftpPort\", \"validation\": {\"required\": false}}, {\"label\": \"用户名\", \"dataType\": \"string\", \"identifier\": \"sftpUsername\", \"validation\": {\"required\": true}}, {\"label\": \"密码\", \"dataType\": \"string\", \"identifier\": \"sftpPassword\", \"validation\": {\"required\": false}}, {\"label\": \"私钥路径\", \"dataType\": \"string\", \"identifier\": \"sftpPrivateKeyPath\", \"validation\": {\"required\": false}}, {\"label\": \"KnownHosts路径\", \"dataType\": \"string\", \"identifier\": \"sftpKnownHostsPath\", \"validation\": {\"required\": false}}, {\"label\": \"分片临时目录\", \"dataType\": \"string\", \"identifier\": \"tempPath\", \"validation\": {\"required\": false}}]','icon-bendicunchu1',NULL,0,'通过 SFTP 协议接入远程服务器目录，支持密码与私钥两种认证方式，适合把文件托管到自有主机。'),(36,'本地入库','LocalMount','[{\"label\": \"挂载显示名\", \"dataType\": \"string\", \"identifier\": \"mountName\", \"validation\": {\"required\": false}}, {\"label\": \"挂载根路径\", \"dataType\": \"string\", \"identifier\": \"rootPath\", \"validation\": {\"required\": true}}, {\"label\": \"实时监听外部变更\", \"dataType\": \"boolean\", \"identifier\": \"realtimeWatch\", \"validation\": {\"required\": false}, \"description\": \"开启后 OS 目录变更事件秒级同步索引；关闭则按扫描间隔定时同步\"}, {\"label\": \"扫描间隔（秒）\", \"dataType\": \"string\", \"identifier\": \"rescanIntervalSeconds\", \"validation\": {\"required\": false}, \"placeholder\": \"留空默认 1800（30 分钟）；开启实时监听时作为兜底全扫周期\"}, {\"label\": \"跟随符号链接\", \"dataType\": \"boolean\", \"identifier\": \"followSymlinks\", \"validation\": {\"required\": false}}, {\"label\": \"开启落盘加密\", \"dataType\": \"boolean\", \"identifier\": \"encryptionEnabled\", \"validation\": {\"required\": false}}, {\"label\": \"加密密钥\", \"showIf\": {\"value\": \"true\", \"identifier\": \"encryptionEnabled\"}, \"dataType\": \"string\", \"identifier\": \"encryptionSecret\", \"validation\": {\"required\": false}, \"placeholder\": \"开启加密后必填，变更密钥将导致旧文件无法解密\"}]','icon-bendicunchu1',NULL,0,'把服务器本地真实目录扫描入库：目录结构镜像进网盘数据库，网盘内的增删改穿透真实文件，外部改动可一键重新扫描同步索引。',(37,'本地挂载','LocalDirect','[{\"label\":\"目录显示名\",\"dataType\":\"string\",\"identifier\":\"mountName\",\"validation\":{\"required\":true},\"description\":\"该本地目录在网盘中显示的文件夹名\",\"placeholder\":\"如 项目文档\"}, {\"label\":\"本地根路径\",\"dataType\":\"string\",\"identifier\":\"rootPath\",\"validation\":{\"required\":true},\"placeholder\":\"如 D:/data 或 D:\\\\data，支持 d: 盘根写法\"}, {\"label\":\"跟随符号链接\",\"dataType\":\"boolean\",\"identifier\":\"followSymlinks\",\"validation\":{\"required\":false}}]','icon-bendicunchu1',NULL,0,'把服务器本地真实目录直接挂进网盘：不建后台索引，浏览时实时列目录，增删改查直接读写真实文件系统，外部改动刷新即可见。'),(38,'内存挂载','Memory','[{\"label\":\"目录显示名\",\"dataType\":\"string\",\"identifier\":\"mountName\",\"validation\":{\"required\":true},\"description\":\"该内存挂载在网盘中显示的文件夹名\",\"placeholder\":\"如 内存盘\"}, {\"label\":\"内存大小（MB）\",\"dataType\":\"string\",\"identifier\":\"capacityMb\",\"validation\":{\"required\":true},\"description\":\"在服务器内存中开辟的容量，按需增长不预分配；实例删除或服务重启后内容即释放。当前环境实际可申请上限见下方实时提示\",\"placeholder\":\"如 512\"}]','icon-bendicunchu1',NULL,0,'在服务器内存中开辟一块指定大小的区域直接挂进网盘：文件不落盘、不建后台索引，浏览时实时列目录，增删改查直接读写内存，实例删除或服务重启后内容即释放。');
